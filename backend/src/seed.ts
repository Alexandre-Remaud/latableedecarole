...
function buildRecipes(userIds: Types.ObjectId[]) {
  ...
  return [
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          order: 2,
          instruction:
            "Caraméliser le sucre avec le beurre dans une poêle allant au four.",
          duration: 10,
          durationUnit: "min",
        ...
        },
        {
          order: 3,
          instruction:
            "Disposer les pommes sur le caramel, couvrir de pâte et cuire au four.",
          temperature: 190,
          temperatureUnit: "C",
          duration: 25,
          durationUnit: "min"
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Fendre la gousse de vanille et infuser dans la crème chauffée.",
          duration: 15,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Blanchir les jaunes avec le sucre puis incorporer la crème filtrée.",
          duration: 5,
          durationUnit: "min"
        },
        {
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Émincer finement les oignons et les faire fondre lentement dans le beurre.",
          duration: 25,
          durationUnit: "min",
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Mettre la moutarde et le vinaigre dans un bol, mélanger.",
          duration: 1,
          durationUnit: "min"
        },
        {
        ...
        },
        {
          order: 3,
          instruction:
            "Assaisonner et conserver au réfrigérateur jusqu'à une semaine."
        }
      ]
    },
    // ── Sophie (index 5-9) ────────────────────────────────────────────────
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          order: 2,
          instruction:
            "Incorporer l'huile d'olive et le jus de citron en mixant brièvement.",
          duration: 1,
          durationUnit: "min"
        },
        {
    ...
    },
    {
      ...
      ingredients: [
        {
          name: "Poissons variés (saint-pierre, grondin)",
          quantity: 1.2,
          unit: "kg"
        },
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Préparer le fumet avec les parures de poisson, fenouil, tomates et pastis.",
          duration: 30,
          durationUnit: "min"
        },
        {
          order: 2,
          instruction:
            "Passer au chinois, remettre sur feu vif et ajouter le safran.",
          duration: 5,
          durationUnit: "min",
        ...
        },
        {
          order: 3,
          instruction:
            "Porter à forte ébullition puis plonger les poissons selon leur temps de cuisson.",
          temperature: 100,
          temperatureUnit: "C",
          duration: 15,
          durationUnit: "min"
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Éplucher et trancher très finement les pommes de terre à la mandoline.",
          duration: 15,
          durationUnit: "min",
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Préparer un sirop en faisant fondre le sucre dans 20 cl d'eau.",
          duration: 5,
          durationUnit: "min",
          temperature: 80,
          temperatureUnit: "C"
        },
        {
          order: 2,
          instruction:
            "Presser les citrons, mélanger le jus avec le sirop refroidi et l'eau plate.",
          duration: 5,
          durationUnit: "min"
        },
        {
          order: 3,
          instruction:
            "Ajouter l'eau gazeuse et la menthe au moment de servir.",
    ...
    // ── Lucas (index 10-14) ───────────────────────────────────────────────
    {
      ...
      ingredients: [
        {
          name: "Bœuf à braiser (paleron ou macreuse)",
          quantity: 1.2,
          unit: "kg"
        },
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Couper le bœuf en gros cubes et faire dorer en plusieurs fois dans le beurre très chaud.",
          duration: 15,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Singer (ajouter la farine), déglacer au vin rouge, ajouter le bouquet garni.",
          duration: 5,
          durationUnit: "min"
        },
        {
        ...
        },
        {
          order: 4,
          instruction:
            "Ajouter champignons et oignons grelots rissolés, poursuivre la cuisson.",
          duration: 30,
          durationUnit: "min"
        }
      ]
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Battre les œufs avec le lait, le sucre vanillé et la cannelle dans un plat creux.",
          duration: 3,
          durationUnit: "min"
        },
        {
          order: 2,
          instruction:
            "Tremper les tranches de brioche dans l'appareil, 1 min de chaque côté.",
          duration: 2,
          durationUnit: "min",
        ...
        },
        {
          order: 3,
          instruction:
            "Cuire à la poêle dans le beurre fondu jusqu'à dorure des deux côtés.",
          duration: 5,
          durationUnit: "min",
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          name: "Bière brune (type Leffe ou Chimay)",
          quantity: 500,
          unit: "ml"
        },
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Faire caraméliser les oignons émincés dans le beurre à feu doux.",
          duration: 20,
          durationUnit: "min"
        },
        {
          order: 2,
          instruction:
            "Faire revenir les morceaux de viande, ajouter les oignons et déglacer à la bière.",
          duration: 10,
          durationUnit: "min"
        },
        {
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Cuire les haricots verts à l'eau bouillante salée puis rafraîchir dans l'eau froide.",
          duration: 7,
          durationUnit: "min",
        ...
        },
        {
          order: 3,
          instruction:
            "Arroser d'huile d'olive, assaisonner et servir aussitôt."
        }
      ]
    },
    {
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Faire fondre le beurre, ajouter la farine d'un coup et fouetter pour former un roux.",
          duration: 2,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Verser le lait chaud progressivement en fouettant vigoureusement pour éviter les grumeaux.",
          duration: 3,
          durationUnit: "min"
        },
        {
          order: 3,
          instruction:
            "Cuire à feu doux en remuant continuellement jusqu'à la consistance désirée.",
          duration: 10,
          durationUnit: "min",
          temperature: 80,
          temperatureUnit: "C"
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Cuire le riz complet dans 2 fois son volume d'eau salée.",
          duration: 25,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Mélanger les pois chiches avec huile, paprika et cumin, rôtir au four.",
          temperature: 200,
          temperatureUnit: "C",
          duration: 20,
          durationUnit: "min"
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          order: 2,
          instruction:
            "Placer tous les ingrédients dans le blender et mixer jusqu'à texture lisse.",
          duration: 2,
          durationUnit: "min",
        ...
        },
        {
          order: 3,
          instruction:
            "Servir immédiatement — les vitamines s'oxydent rapidement."
        }
      ]
    },
    {
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Égoutter les pois chiches en gardant 3 cs de leur eau de cuisson (aquafaba).",
          duration: 2,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Mixer pois chiches, tahini, citron et ail avec l'aquafaba.",
          duration: 3,
          durationUnit: "min"
        },
        {
          order: 3,
          instruction:
            "Incorporer l'huile et le cumin, mixer encore jusqu'à texture soyeuse.",
          duration: 2,
          durationUnit: "min"
        }
      ]
    },
    {
      ...
      steps: [
        ...
        },
        {
          order: 2,
          instruction:
            "Hacher très finement le persil, la menthe, les tomates et le concombre.",
          duration: 10,
          durationUnit: "min"
        },
        {
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          order: 3,
          instruction:
            "Verser sur la base biscuitée et réfrigérer 12 h minimum.",
      ...
      steps: [
        {
          order: 1,
          instruction:
            "Faire revenir l'oignon émincé avec les épices dans l'huile d'olive.",
          duration: 5,
          durationUnit: "min",
        ...
        },
        {
          order: 2,
          instruction:
            "Ajouter les lentilles rincées et le bouillon, cuire à feu moyen.",
          duration: 20,
          durationUnit: "min"
        },
        {
          order: 3,
          instruction:
            "Verser le lait de coco et mixer au mixeur plongeant jusqu'à texture veloutée.",
          duration: 5,
          durationUnit: "min",
          temperature: 80,
          temperatureUnit: "C"
...
function buildReviews(userIds: Types.ObjectId[], recipeIds: Types.ObjectId[]) {
  ...
  return [
    // Recipe 0 : Quiche Lorraine (carole) → sophie, lucas
    {
      ...
      rating: 4,
      comment: "Une quiche parfaite, j'ai adoré le croquant de la pâte !"
    },
    {
      userId: lucasId,
      recipeId: recipeIds[0],
      rating: 5,
      comment: "Meilleure recette de quiche lorraine que j'aie essayée."
    },
    // Recipe 1 : Tarte Tatin (carole) → emma, lucas
    {
      ...
      rating: 5,
      comment: "Absolument délicieux, le caramel était parfait."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[1],
      rating: 4,
      comment: "Très bien réussie, je referai sans hésiter."
    },
    // Recipe 2 : Crème Brûlée (carole) → sophie, emma
    {
      ...
      rating: 5,
      comment: "Magnifique crème brûlée, digne d'un restaurant."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[2],
      rating: 3,
      comment: "Un peu difficile à maîtriser mais le résultat en vaut la peine."
    },
    // Recipe 3 : Soupe à l'Oignon (carole) → lucas, emma
    {
      ...
      rating: 4,
      comment: "Réconfortante et savoureuse, parfaite en hiver."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[3],
      rating: 5,
      comment: "Parfaite pour les soirées froides, mes invités ont adoré."
    },
    // Recipe 4 : Vinaigrette (carole) → sophie, emma
    {
      ...
      rating: 5,
      comment:
        "Simple et parfaite, je ne ferai plus jamais de vinaigrette autrement."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[4],
      rating: 4,
      comment: "Je l'utilise maintenant pour toutes mes salades."
    },
    // Recipe 5 : Ratatouille (sophie) → carole, lucas, emma
    {
      ...
      rating: 5,
      comment:
        "Authentique et savoureuse, les légumes étaient parfaitement cuits."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[5],
      rating: 4,
      comment: "Les saveurs du Sud dans l'assiette, un régal."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[5],
      rating: 5,
      comment:
        "Mes légumes préférés ! La meilleure ratatouille que j'aie goûtée."
    },
    // Recipe 6 : Tapenade (sophie) → carole, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[6],
      rating: 4,
      comment: "Parfait pour l'apéro, texture idéale."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[6],
      rating: 3,
      comment: "Un peu fort pour mes papilles mais mes amis ont adoré."
    },
    // Recipe 7 : Bouillabaisse (sophie) → carole, lucas, emma
    {
      userId: caroleId,
      recipeId: recipeIds[7],
      rating: 5,
      comment: "Comme à Marseille ! Impressionnant de fidélité."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[7],
      rating: 4,
      comment: "Bluffant, je ne pensais pas réussir une bouillabaisse maison."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[7],
      rating: 2,
      comment:
        "Pas pour les végétariens mais j'ai quand même goûté le bouillon."
    },
    // Recipe 8 : Gratin dauphinois (sophie) → carole, lucas, emma
    {
      userId: caroleId,
      recipeId: recipeIds[8],
      rating: 5,
      comment: "Fondant à souhait, exactement comme celui de ma grand-mère."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[8],
      rating: 5,
      comment: "Le meilleur gratin que j'aie mangé de ma vie."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[8],
      rating: 4,
      comment: "Très généreux et onctueux, j'en referai pour Noël."
    },
    // Recipe 9 : Limonade (sophie) → carole, lucas, emma
    {
      userId: caroleId,
      recipeId: recipeIds[9],
      rating: 4,
      comment: "Rafraîchissante et juste assez sucrée."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[9],
      rating: 5,
      comment: "Meilleure que toutes les limonades du commerce !"
    },
    {
      userId: emmaId,
      recipeId: recipeIds[9],
      rating: 5,
      comment: "Parfaite pour l'été, je la fais chaque week-end."
    },
    // Recipe 10 : Bœuf Bourguignon (lucas) → carole, sophie
    {
      userId: caroleId,
      recipeId: recipeIds[10],
      rating: 5,
      comment: "Authentique et savoureux, la viande était fondante."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[10],
      rating: 4,
      comment: "Long à préparer mais ça vaut vraiment le coup."
    },
    // Recipe 11 : Pain Perdu (lucas) → carole, sophie, emma
    {
      userId: caroleId,
      recipeId: recipeIds[11],
      rating: 5,
      comment: "Les enfants adorent, je le fais maintenant chaque dimanche."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[11],
      rating: 5,
      comment: "Rapide et tellement délicieux !"
    },
    {
      userId: emmaId,
      recipeId: recipeIds[11],
      rating: 4,
      comment: "Mon brunch favori, je le fais avec du pain rassis."
    },
    // Recipe 12 : Carbonnade (lucas) → carole, sophie
    {
      userId: caroleId,
      recipeId: recipeIds[12],
      rating: 4,
      comment: "Le pain d'épices, c'est vraiment le secret de cette recette."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[12],
      rating: 5,
      comment: "Un classique belge parfaitement exécuté."
    },
    // Recipe 13 : Salade niçoise (lucas) → carole, sophie, emma
    {
      userId: caroleId,
      recipeId: recipeIds[13],
      rating: 4,
      comment: "Fraîche et bien équilibrée."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[13],
      rating: 3,
      comment: "Manquait un peu de sel à mon goût mais bien présentée."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[13],
      rating: 5,
      comment: "J'adore cette version, très proche de l'originale."
    },
    // Recipe 14 : Béchamel (lucas) → carole, sophie, emma
    {
      userId: caroleId,
      recipeId: recipeIds[14],
      rating: 5,
      comment: "Inratable avec ces explications, texture parfaite."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[14],
      rating: 4,
      comment: "Très bien expliqué, même un débutant peut réussir."
    },
    {
      userId: emmaId,
      recipeId: recipeIds[14],
      rating: 4,
      comment: "Texture parfaite, je l'utilise pour mes lasagnes végétariennes."
    },
    // Recipe 15 : Buddha Bowl (emma) → carole, sophie, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[15],
      rating: 4,
      comment: "Coloré, sain et très bon. Une belle découverte."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[15],
      rating: 4,
      comment: "Ma fille adore, on en fait toutes les semaines !"
    },
    {
      userId: lucasId,
      recipeId: recipeIds[15],
      rating: 3,
      comment: "Bon mais un peu léger pour moi, j'ai ajouté des œufs."
    },
    // Recipe 16 : Smoothie vert (emma) → carole, sophie
    {
      userId: caroleId,
      recipeId: recipeIds[16],
      rating: 5,
      comment: "Plein de vitamines et vraiment bon !"
    },
    {
      userId: sophieId,
      recipeId: recipeIds[16],
      rating: 5,
      comment: "Je le fais chaque matin maintenant."
    },
    // Recipe 17 : Houmous (emma) → carole, sophie, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[17],
      rating: 5,
      comment: "Bien meilleur que le commerce, texture incroyable !"
    },
    {
      userId: sophieId,
      recipeId: recipeIds[17],
      rating: 4,
      comment: "Bien dosé en citron et en tahini."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[17],
      rating: 4,
      comment: "Surprenant pour quelqu'un qui ne mangeait pas de houmous !"
    },
    // Recipe 18 : Taboulé (emma) → carole, sophie, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[18],
      rating: 4,
      comment: "Parfait pour les repas d'été."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[18],
      rating: 5,
      comment: "Mon taboulé préféré, généreux en herbes comme il se doit."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[18],
      rating: 3,
      comment: "Pas fan du persil en grande quantité mais c'est personnel."
    },
    // Recipe 19 : Cheesecake vegan (emma) → carole, sophie, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[19],
      rating: 5,
      comment: "Incroyable pour un dessert vegan, même mon mari a aimé !"
    },
    {
      userId: sophieId,
      recipeId: recipeIds[19],
      rating: 4,
      comment: "La texture crémeuse est bluffante sans produits laitiers."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[19],
      rating: 4,
      comment: "J'ai été surpris, c'est vraiment bon."
    },
    // Recipe 20 : Velouté lentilles (emma) → carole, sophie, lucas
    {
      userId: caroleId,
      recipeId: recipeIds[20],
      rating: 5,
      comment: "Chaud, réconfortant et très parfumé."
    },
    {
      userId: sophieId,
      recipeId: recipeIds[20],
      rating: 4,
      comment: "Le lait de coco adoucit parfaitement les épices."
    },
    {
      userId: lucasId,
      recipeId: recipeIds[20],
      rating: 5,
      comment: "Je le refais toutes les semaines, c'est devenu mon plat favori."
    }
  ]
}
...
function buildFavorites(
  ...
  return [
    ...
    { userId: caroleId, recipeId: recipeIds[5] },
    { userId: caroleId, recipeId: recipeIds[8] },
    { userId: caroleId, recipeId: recipeIds[10] },
    { userId: caroleId, recipeId: recipeIds[19] },
    { userId: caroleId, recipeId: recipeIds[17] },
    // Sophie (recettes de Carole, Lucas, Emma uniquement)
    { userId: sophieId, recipeId: recipeIds[0] },
    { userId: sophieId, recipeId: recipeIds[2] },
    { userId: sophieId, recipeId: recipeIds[10] },
    { userId: sophieId, recipeId: recipeIds[18] },
    { userId: sophieId, recipeId: recipeIds[15] },
    // Lucas (recettes de Carole, Sophie, Emma uniquement)
    { userId: lucasId, recipeId: recipeIds[5] },
    { userId: lucasId, recipeId: recipeIds[1] },
    { userId: lucasId, recipeId: recipeIds[18] },
    { userId: lucasId, recipeId: recipeIds[16] },
    { userId: lucasId, recipeId: recipeIds[19] },
    // Emma (recettes de Carole, Sophie, Lucas uniquement)
    { userId: emmaId, recipeId: recipeIds[3] },
    { userId: emmaId, recipeId: recipeIds[4] },
    { userId: emmaId, recipeId: recipeIds[9] },
    { userId: emmaId, recipeId: recipeIds[8] },
    { userId: emmaId, recipeId: recipeIds[6] },
    { userId: emmaId, recipeId: recipeIds[11] }
  ]
}
